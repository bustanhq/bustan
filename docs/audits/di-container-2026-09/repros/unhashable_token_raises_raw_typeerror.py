"""PN-06: provider tokens are used as dict keys without validation; an unhashable provide value
...
def main() -> None:
    try:
        ...
        print(f"RESULT: PN-06 FIXED - framework error {type(exc).__name__}")
    except TypeError as exc:
        print(f"RESULT: PN-06 REPRODUCED - raw TypeError escaped: {exc}")
