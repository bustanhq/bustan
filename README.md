<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/bustanhq/bustan/v2.0.3/docs/assets/bustan-wordmark-dark.svg">
  <img src="https://raw.githubusercontent.com/bustanhq/bustan/v2.0.3/docs/assets/bustan-wordmark.svg" alt="Bustan" width="260">
</picture>
...
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/bustanhq/bustan/blob/v2.0.3/LICENSE)
...
[Your first app](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/tutorials/first-app.md) - the
first of [six tutorials](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md#tutorials)
that build a working link shortener from this scaffold.

## Documentation

[**Read the docs**](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md), organised by
what you are doing:

| | |
| --- | --- |
| [Tutorials](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md#tutorials) | Learning. One path, start to finish. |
| [How-to guides](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md#how-to-guides) | A task in hand: deploy, observe, harden, migrate, test. |
| [Reference](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md#reference) | Looking something up: API, CLI, errors, routing, lifecycle. |
| [Explanation](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/README.md#explanation) | Understanding: request scope, layering, the security model. |

**Upgrading from 1.x?** 2.0 is a clean break and a 1.x application will not start on it until it is
corrected. Start at
[Migrate from 1.x](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/how-to/migrate-from-1x.md);
...
[Stability](https://github.com/bustanhq/bustan/blob/v2.0.3/docs/reference/stability.md) is the
...
[Browse them](https://github.com/bustanhq/bustan/blob/v2.0.3/examples/README.md), or run one:
...
[CONTRIBUTING.md](https://github.com/bustanhq/bustan/blob/v2.0.3/CONTRIBUTING.md) covers development
setup and the checks to run;
[GOVERNANCE.md](https://github.com/bustanhq/bustan/blob/v2.0.3/GOVERNANCE.md) covers how decisions
get made.
...
[SECURITY.md](https://github.com/bustanhq/bustan/blob/v2.0.3/SECURITY.md), not through public
issues. Participation is governed by the
[Code of Conduct](https://github.com/bustanhq/bustan/blob/v2.0.3/CODE_OF_CONDUCT.md).
...
[MIT](https://github.com/bustanhq/bustan/blob/v2.0.3/LICENSE)
